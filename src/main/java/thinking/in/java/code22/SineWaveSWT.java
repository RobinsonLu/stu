...
public class SineWaveSWT implements SWTApplication {

	private SineDrawSWT sines;
	private Slider slider;
	
	public void createContents(Composite parent) {
		parent.setLayout(new GridLayout(1, true));
		sines = new SineDrawSWT(parent, SWT.NONE);
	...
	public static void main(String[] args) {
		SWTConsole.run(new SineWaveSWT(), 700, 400);
	}

}

class SineDrawSWT extends Canvas {
	...
	public SineDrawSWT(Composite parent, int style) {
		super(parent, style);
